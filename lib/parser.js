module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c124 = function(body, modifiers) { return { type:'output', content:body, modifiers:modifiers || [] }; },
        peg$c125 = "{",
        peg$c126 = { type: "literal", value: "{", description: "\"{\"" },
        peg$c127 = function(type, body, modifiers) { return enterSegment(type), { type:type, content:body, modifiers:modifiers || [] }; },
        peg$c128 = function(type, body, modifiers) { return enterSegment(type, true), { type:type, content:body, modifiers:modifiers || [], closing:true }; },
        peg$c129 = "|",
        peg$c130 = { type: "literal", value: "|", description: "\"|\"" },
        peg$c131 = function(type) { return nextSegment(type), { type:type, next:true }; },
        peg$c132 = function(type) { return exitSegment(type), { type:type, closing:true }; },
        peg$c133 = /^[{]/,
        peg$c134 = { type: "class", value: "[{]", description: "[{]" },
        peg$c135 = /^[^{]/,
        peg$c136 = { type: "class", value: "[^{]", description: "[^{]" },
        peg$c137 = function(str) { return (str[0] || '') + str[1].join(''); },
        peg$c138 = function(txt) { return { type:'text', content:txt }; },
        peg$c139 = "\\",
        peg$c140 = { type: "literal", value: "\\", description: "\"\\\\\"" },
        peg$c141 = function(ctx, expr) { return { context:ctx && ctx[0].context, expression:expr }; },
        peg$c142 = function(left, right) { return [{ name:left.name, args:left.args }].concat(right); },
        peg$c143 = function(left, right) { return [{ name:left, args:[] }].concat(right); },
        peg$c144 = function(left) { return [{ name:left.name, args:left.args }]; },
        peg$c145 = function(left) { return [{ name:left, args:[] }]; },
