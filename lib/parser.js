module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c86 = function(p) { return p.join(''); },
        peg$c87 = function(left, sep, right) { return left + sep.join('') + right; },
        peg$c88 = function(parent, path) { return (parent || '') + path; },
        peg$c89 = function(left, right) { return left + '.' + right; },
        peg$c90 = ":",
        peg$c91 = { type: "literal", value: ":", description: "\":\"" },
        peg$c92 = function(path, args, props) { return { context:path, args:args, props:props }; },
        peg$c93 = function(path, args) { return { context:path, args:args }; },
        peg$c94 = function(path, props) { return { context:path, props:props }; },
        peg$c95 = function(path) { return { context:path }; },
        peg$c96 = function(val) { return { type:'reserved', value:val }; },
        peg$c97 = function(val) { return { type:'context', value:val }; },
        peg$c98 = function(val) { return { type:'string', value:val }; },
        peg$c99 = function(val) { return { type:'number', value:val }; },
        peg$c100 = "?",
        peg$c101 = { type: "literal", value: "?", description: "\"?\"" },
        peg$c102 = function() { return 'conditional'; },
        peg$c103 = function() { return 'switch'; },
        peg$c104 = "@",
        peg$c105 = { type: "literal", value: "@", description: "\"@\"" },
        peg$c106 = function() { return 'iterator'; },
        peg$c107 = "&",
        peg$c108 = { type: "literal", value: "&", description: "\"&\"" },
        peg$c109 = function() { return 'custom'; },
        peg$c110 = "#",
        peg$c111 = { type: "literal", value: "#", description: "\"#\"" },
        peg$c112 = function() { return 'namedDeclare'; },
        peg$c113 = function() { return 'namedRender'; },
        peg$c114 = ">",
        peg$c115 = { type: "literal", value: ">", description: "\">\"" },
        peg$c116 = function() { return 'partial'; },
        peg$c117 = function(seg) { seg.offset = offset(); seg.line = line(); seg.column = column(); return seg; },
        peg$c118 = /^[^{]/,
        peg$c119 = { type: "class", value: "[^{]", description: "[^{]" },
        peg$c120 = function(txt) { return { type:'text', content:txt.join('') }; },
        peg$c121 = "{{",
        peg$c122 = { type: "literal", value: "{{", description: "\"{{\"" },
        peg$c123 = "}",
        peg$c124 = { type: "literal", value: "}", description: "\"}\"" },
        peg$c125 = function(body, modifiers) { return { type:'output', content:body, modifiers:modifiers || [] }; },
        peg$c126 = "{",
        peg$c127 = { type: "literal", value: "{", description: "\"{\"" },
        peg$c128 = function(type, body, modifiers) { return enterSegment(type), { type:type, content:body, modifiers:modifiers || [] }; },
        peg$c129 = function(type, body, modifiers) { return enterSegment(type, true), { type:type, content:body, modifiers:modifiers || [], closing:true }; },
        peg$c130 = "|",
        peg$c131 = { type: "literal", value: "|", description: "\"|\"" },
        peg$c132 = function(type) { return nextSegment(type), { type:type, next:true }; },
        peg$c133 = function(type) { return exitSegment(type), { type:type, closing:true }; },
        peg$c134 = "\\",
        peg$c135 = { type: "literal", value: "\\", description: "\"\\\\\"" },
        peg$c136 = function(ctx, expr) { return { context:ctx && ctx[0].context, expression:expr }; },
        peg$c137 = function(left, right) { return [{ name:left.name, args:left.args }].concat(right); },
        peg$c138 = function(left, right) { return [{ name:left, args:[] }].concat(right); },
        peg$c139 = function(left) { return [{ name:left.name, args:left.args }]; },
        peg$c140 = function(left) { return [{ name:left, args:[] }]; },
