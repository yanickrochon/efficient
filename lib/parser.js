module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c124 = function(type, body, modifiers) { return { type:type, content:body, modifiers:modifiers || [], closing:true }; },
        peg$c125 = "|",
        peg$c126 = { type: "literal", value: "|", description: "\"|\"" },
        peg$c127 = function(type) { return checkSegment(type), { type:type, next:true }; },
        ...
        peg$c132 = function(left, right) { return [{ name:left.context, args:left.args }].concat(right); },
        peg$c133 = function(left) { return [{ name:left.name, args:left.args }]; },
        peg$c134 = function(left) { return [{ name:left, args:[] }]; },
