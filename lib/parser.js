module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c0 = [],
        peg$c1 = peg$FAILED,
        peg$c2 = function(seg) { return cleanup(), seg; },
        peg$c3 = " ",
        ...
        peg$c74 = function(name, args) { return { name:name, args:args[0] }; },
        peg$c75 = function(name) { return { name:name, args:[] }; },
        peg$c76 = function(path, args) { return { context:'ctx.getContext("' + path + '").data', args:args }; },
        peg$c77 = function(path) { return { context:'ctx.getContext("' + path + '").data', args:[] }; },
        peg$c78 = function(path) { return { context:'ctx.getContext("' + path + '").data' }; },
        peg$c79 = function(val) { return { type:'reserved', value:val }; },
        peg$c80 = function(val) { return { type:'context', value:val }; },
        peg$c81 = function(val) { return { type:'string', value:val }; },
        peg$c82 = function(val) { return { type:'number', value:val }; },
        peg$c83 = ",",
        ...
        peg$c89 = function() { return 'conditional'; },
        peg$c90 = function() { return 'switch'; },
        peg$c91 = "@",
        peg$c92 = { type: "literal", value: "@", description: "\"@\"" },
        peg$c93 = function() { return 'iterator'; },
        peg$c94 = "&",
        peg$c95 = { type: "literal", value: "&", description: "\"&\"" },
        peg$c96 = function() { return 'custom'; },
        peg$c97 = "#",
        peg$c98 = { type: "literal", value: "#", description: "\"#\"" },
        peg$c99 = function() { return 'namedDeclare'; },
        peg$c100 = function() { return 'namedRender'; },
        peg$c101 = ">",
        peg$c102 = { type: "literal", value: ">", description: "\">\"" },
        peg$c103 = function() { return 'partial'; },
        peg$c104 = function(seg) { seg.offset = offset(); seg.line = line(); seg.column = column(); return seg; },
        peg$c105 = /^[^{]/,
        peg$c106 = { type: "class", value: "[^{]", description: "[^{]" },
        peg$c107 = function(txt) { return { type:'text', content:txt.join('') }; },
        peg$c108 = "{{",
        peg$c109 = { type: "literal", value: "{{", description: "\"{{\"" },
        peg$c110 = "}",
        peg$c111 = { type: "literal", value: "}", description: "\"}\"" },
        peg$c112 = function(body, modifiers) { return { type:'output', content:body, modifiers:modifiers || [] }; },
        peg$c113 = "{",
        peg$c114 = { type: "literal", value: "{", description: "\"{\"" },
        peg$c115 = function(type, body, modifiers) { enterSegment(type); return { type:type, content:body, modifiers:modifiers || [] }; },
        peg$c116 = "/}",
        peg$c117 = { type: "literal", value: "/}", description: "\"/}\"" },
        peg$c118 = function(type, body, modifiers) { return { type:type, content:body, modifiers:modifiers || [], closing:true }; },
        peg$c119 = "|",
        peg$c120 = { type: "literal", value: "|", description: "\"|\"" },
        peg$c121 = "}}",
        peg$c122 = { type: "literal", value: "}}", description: "\"}}\"" },
        peg$c123 = function(type) { return checkSegment(type); },
        peg$c124 = void 0,
        peg$c125 = function(type) { return { type:type, next:true }; },
        peg$c126 = function(type) { return exitSegment(type); },
        peg$c127 = function(type) { return { type:type, closing:true }; },
        peg$c128 = "\\",
        peg$c129 = { type: "literal", value: "\\", description: "\"\\\\\"" },
        peg$c130 = function(ctx, expr) { return { context:ctx && ctx[0], expression:expr }; },
        peg$c131 = function(val, op, expr) { return [ val, op ].concat(expr); },
        peg$c132 = function(open, expr, close) { return [open].concat(expr).concat([close]); },
        peg$c133 = function(val) { return [val]; },
        peg$c134 = function(left, right) { return [{ name:left.context, args:left.args }].concat(right); },
        peg$c135 = function(left) { return [{ name:left.name, args:left.args }]; },
        peg$c136 = function(left) { return [{ name:left, args:[] }]; },
