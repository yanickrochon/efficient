...
const TEMPLATES = {
  ...
  // Segment: iterator
  'seg.iterator': 'engine.iterator(__CTX__,__EXPR__,__FN__).then(function(){return c;});',
  ...
  // Segment: custom
  'seg.custom': 'engine.callCustom(__CTX__,__EXPR__,__SEGMENTS__).then(function(){return c;});'
