...
const TEMPLATES = {
  ...
  // Segment: custom
  'seg.custom': 'engine.callCustom(__EXPR__,__CTX__,__SEGMENTS__)',
...
function segmentIterator(segments, depth) {
  var index = 0;
  ...
  return {
    ...
    consume: function (cb) {
      ...
      return segmentIterator(segments.slice(startIndex, index), depth + 1);
    }
  };
}
