  ...
  Object.defineProperties(this, {
    ...
    'render': {
      ...
      value: function render(name, data) {
        ...
        return renderTemplate(name, ctx, internalEngine, this).then(function () {
    ...
    return engine._cache[name] = new Promise(function (resolve, reject) {
      ...
      var pathPrefix = Object.keys(paths).filter(function (prefix) {
        ...
        if (a === '*') {
          ...
          var ac = a.split(path.sep).length;
          var bc = b.split(path.sep).length;

          return ac === bc ? a.localeCompare(b) : bc - ac;
        }
      });
      var pathCount;
          ...
          fs.stat(file, function (err, stat) {
            if (err || !stat.isFile()) {
              ...
              if (Engine._cache[file]) {
                ...
                resolve(Engine._cache[file] = { name: file });
              }
            }
          });
        }
